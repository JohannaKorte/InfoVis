...
function updateData() {
  ...
  // var svg = d3.select("#line-svg").transition();
  // console.log(svg);
  // Make the changes

  // var path = svg.select(".city:path").attr("d", line(data));
  // path
  //    .transition()
  //    .duration(300)
  //    .attr("d", line(data));
...
// TODO: Remove line chart update.... hide rect to keep axis and mouseg when country is deselected.
